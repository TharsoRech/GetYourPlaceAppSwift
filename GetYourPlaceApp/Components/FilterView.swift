...
struct FilterView: View {
    ...
    init(filter: Binding<ResidenceFilter>, applyChanges: @escaping () -> Void) {
        self._filter = filter
                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: 25) {
                        ...
                        VStack(alignment: .leading) {
                            ...
                            Slider(value: $draftFilter.maxPrice, in: 500...10000, step: 100)
                                .tint(.white)
                        ...
                        VStack(alignment: .leading) {
                            ...
                            Slider(value: $draftFilter.maxSquareFootage, in: 500...10000, step: 100)
                                .tint(.white)
...
#Preview {
    FilterView(filter:.constant(.mock), applyChanges: { })
}
